...
%token ABSTRACT ASSERT BRACES_LEFT BRACES_RIGHT BRACKET_LEFT BRACKET_RIGHT BREAK CASE CATCH CLASS CONST CONTINUE DEFAULT DO ELSE ENUM EXTENDS FINAL FINALLY FOR GOTO IF IMPLEMENTS IMPORT INTERFACE LITERAL_FALSE LITERAL_NULL LITERAL_TRUE NATIVE NEW OP_ASSIGN OP_BITWISEAND OP_BITWISENOT OP_BITWISEOR OP_BITWISEXOR OP_DECREMENT OP_DIVIDE OP_EQUAL OP_GREATER OP_GREATEROREQUAL OP_INCREMENT OP_INSTANCEOF OP_LESS OP_LESSOREQUAL OP_LOGICALAND OP_LOGICALOR OP_MINUS OP_MULTIPLY OP_NOT OP_NOTEQUAL OP_PLUS OP_REMAINDER OP_SHIFTLEFT OP_SHIFTRIGHT OP_TERNARYBEGIN OP_TERNARYBETWEEN OP_UNSIGNEDSHIFTRIGHT PACKAGE PARANTHESES_LEFT PARANTHESES_RIGHT PRIVATE PROTECTED PUBLIC RETURN STATIC STRICTFP SUPER SWITCH SYNCHRONIZED THIS THROW THROWS TRANSIENT TRY TYPE_BOOLEAN TYPE_BYTE TYPE_CHAR TYPE_DOUBLE TYPE_FLOAT TYPE_INT TYPE_LONG TYPE_SHORT VOID VOLATILE WHILE LITERAL_INTEGER LITERAL_FLOATING LITERAL_STRING LITERAL_CHARACTER
